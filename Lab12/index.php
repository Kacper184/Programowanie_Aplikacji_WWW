...
<body onload="startclock()">
    ...
    echo '<li class="nv-li"><a class="nv-links" href="admin/admin.php">Admin Panel</a></li>';
    echo '<li class="nv-li"><a class="nv-links" href="admin/products.php">Lista Produktow</a></li>';
    echo '<li class="nv-li"><a class="nv-links" href="admin/shop.php">Sklep</a></li>';
    echo '<li class="nv-li"><a class="nv-links" href="koszyk.php">Koszyk</a></li>';
    ?>
    <footer>
        <div class="foot">
